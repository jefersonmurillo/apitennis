...
function cargarDatos() {
    ...
    for (let i = 0; i < instalacnes.length; i++) {
        html += '' +
            ...
            '                <img class="img-circle" src="http://localhost:8000/template/dist/img/user2-160x160.jpg"\n' +
            '                     alt="User Image">\n' +
            ...
            '                    <li><a href="http://localhost:8000/instalaciones/'+instalacnes[i].id+'">Modificar</a></li>\n' +
            '                    <li class="divider"></li>\n' +
            ...
            '        <!-- /.box-header -->\n' +
            '        <div class="box-body">\n' +
            '            <img class="img-responsive pad" src="http://localhost:8000/' + instalacnes[i].imagen_destacada + '" alt="Photo">\n' +
            '\n' +
